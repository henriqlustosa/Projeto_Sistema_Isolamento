...
public partial class Relatorio_Graficos_3 : System.Web.UI.Page
{
    ...
    protected void btnCarregar3_Click(object sender, EventArgs e)
    {
         string anoPesquis = ddlAno2.SelectedItem.Text;
            ...
            if (anoPesquis == "Tudo")
            {
                ...
                "SELECT distinct e.[rh],mic.descricao, MONTH(e.dt_resultado) as mes " +
    ...
    protected void btnCarregar4_Click(object sender, EventArgs e)
    {
        ...
        if (anoPesquis == "Tudo")
        {
            ...
            "SELECT mes , count(*) as Total FROM (SELECT distinct e.rh , mic.descricao as mic, tm.descricao as tm,gm.descricao as gm, e.dt_cadastro,MONTH(e.dt_resultado) as mes FROM [Isolamento].[dbo].[Exame] as e " +
